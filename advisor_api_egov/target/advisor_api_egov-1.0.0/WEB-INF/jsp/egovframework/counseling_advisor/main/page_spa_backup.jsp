	    ...
	    stomp.connect({}, function () {
	        ...
	        stomp.subscribe('/topic/answer', function (event) {
                ...
                '<div class="counsel_date"><p>2023.12.31.23.59.59</p></div>' +
	                    ...
	                    '<span><input type="checkbox" id="check'+$("#answer_cnt").val()+'" name="check'+$("#answer_cnt").val()+'"><label for="check'+$("#answer_cnt").val()+'"></label></span>' +
	                    '</div>' +
	                    '<h4>'+ messageData.AI.question+'</h4>' +
	                    '<p>'+messageData.AI.answer+'</p>' +
	                    '</div>' +
	                    '<div class="counsel_more_btn"><a href="#">더보기<i><img src="/advisor_api_egov/images/icons/arr_down.png" alt=""></i></a></div>' +
	                    '</div>' +
	                    '</li>' +
	                    '<li class="kms_part">' +
	                    '<h3>KMS</h3>' +
	                    ...
	                    for (var i = 0; i < messageData.KMS.length; i++) {
	                    	  ...
	                    	  insertedHTML += '<li><a href="#"><div class="kms_part_con"><p>'+messageData.KMS[i].title+'</p>' +
			                    '<span><input type="checkbox" id="kms_check_'+$("#answer_cnt").val()+'" name="kms_check_'+$("#answer_cnt").val()+'"><label for="kms_check_'+$("#answer_cnt").val()+'"></label></span>' +
			                    '</div></a></li>';
	                    }
