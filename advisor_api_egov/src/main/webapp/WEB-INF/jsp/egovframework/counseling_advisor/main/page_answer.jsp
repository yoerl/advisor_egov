...
%>
	...
	<script>
	$("#answer_cnt").val("0");
	function handleEnterAnswer(event) {
		  if (event.key === 'Enter') {
			  fn_ai_quiry_answer();
		  }
		}
				...
				<div class="counsel">
					<!-- 검색 -->
						<div class="counsel_search">
								...
								<input id="text_adv_menual_question" type="text" size="20" name="" value="" placeholder="검색어를 입력하세요." onkeydown="handleEnterAnswer(event)">
