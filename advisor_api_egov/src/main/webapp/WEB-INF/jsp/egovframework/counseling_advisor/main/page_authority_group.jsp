...
function setActive(index) {
  ...
  $(".setting_btn").css("display", "block");
  

  $.ajax({
      type: "GET",
      url: "${path}/api/auth/menu/"+$("#agentSelect").val()+"/"+comnCdVal+".do",
				...
				<div class="right_contents">
					<div class="notice_con_inner" style="height:100%;">
								 ...
								 <div class="group_autho_list"  id="group_autho_list" style="display:none">
									...
									<caption></caption>
									  ...
									  <tr>
										...
										<td  class="border_none w30">요약</td>
									  ...
									  <tr>
										...
										<td class="w30"></td>
										<td class="w20"><span class="radios"><input type="radio"  name = "systemcheck" value="N" id="systemcheck_y"> <label for="systemcheck_y">미점검중</label></span></td>
										<td class="w20"><span class="radios"><input type="radio"  name = "systemcheck"  value="Y" id="systemcheck_n"> <label for="systemcheck_n">점검중</label></span></td>
									  </tr>
									</table>
						...
						<input type="hidden" id="role_code" value = "" />
							<div class="setting_btn" style="display:none;">
								<a href="#" id="btn_setting">저장</a>
							</div>
	...
	$("#btn_setting").on("click", function () {
	 ...
	 // 모든 라디오 버튼을 선택합니다.
	    ...
	    var requestData = {
	        ...
	        systemChk: checkedRadioValues.systemcheck,
