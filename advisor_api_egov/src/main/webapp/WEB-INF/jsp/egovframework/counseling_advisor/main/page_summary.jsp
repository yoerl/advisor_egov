...
.tui-page-btn.tui-last-child {
    display: none;
}

.tui-page-btn.tui-first-child {
    display: none;
}
			        ...
			        var listItem = `
			            <li>
			                <a href="javascript:fnPageLoad('${path}/page/summary_view.do','callId=`+item.callId+`');">
			                    <p class=".ellipsis-text" style="margin-right: 80px;">`+item.kmsMemoCntn+`</p>
				...
				<div class="right_contents">
					<div class="notice_con_inner">
						<div class="board_search">
								<input id="serch_text" type="text" name="" value="" placeholder="검색어를 입력하세요." onkeydown="handleEnter(event)">
